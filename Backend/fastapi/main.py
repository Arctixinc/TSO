...
async def media_management(request: Request, media_type: str = "movie", page: int = 1, _: bool = Depends(require_auth)):
    return await media_management_page(request, media_type, page, _)
